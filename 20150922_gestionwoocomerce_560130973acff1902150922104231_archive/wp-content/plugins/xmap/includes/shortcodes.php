...
function xmap_shortcode_handler($atts, $content, $code) {
	...
	extract( shortcode_atts( array(
		...
		$src = "http://$domain/$dir/widget?width=$width&amp;height=$height&amp;extended=$extended&amp;unit=$unit&amp;redirect=no";
		
		return xmap_print_map($src, (int) $width, $extended == 'true' ? (int) $height + 105 : (int) $height);
}
